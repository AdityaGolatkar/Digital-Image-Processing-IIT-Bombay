function [image_op] = LineExtraction4(sigma_m,sigma_c)
    ...
    for v= max_ST+1:sz2(2)-max_ST-1
        for u = max_ST+1:sz2(1)-max_ST-1
            ...
            for f = 2:S+1
                ...
                elseif (-67.5 <= angle4 <= -22.5)
                        sum_s = sum_s + H_g(u2-1,v2+1)*g_s;
                        u2 = u2-1;
                        v2 = v2+1;
                        
                elseif ((angle5 >= -22.5) && (angle5 <= 22.5))   
                        sum_s = sum_s + H_g(u2-1,v2)*g_s;
                        u2 = u2-1;
                        
                elseif ((angle6 <= 67.5) && (angle6 >= 22.5))
                        sum_s = sum_s + H_g(u2-1,v2-1)*g_s;
                        u2 = u2-1;
                        v2 = v2-1;
                        
                elseif ((angle7 >= 67.5) && (angle7 <= 112.5))  
                        sum_s = sum_s + H_g(u2,v2-1)*g_s;
                        v2 = v2-1;
                        
                elseif (112.5 <= angle8 && angle8 <= 157.5)
                        sum_s = sum_s + H_g(u2+1,v2-1)*g_s;
                        u2 = u2+1;
                        v2 = v2-1;
                end
